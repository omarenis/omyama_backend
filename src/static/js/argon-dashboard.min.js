...
function navbarBlurOnScroll(e) {
  ...
  let n = ["bg-white", "left-auto", "position-sticky"], i = ["shadow-none"];
...
function initNavs() {
  total.forEach(function (l, e) {
    ...
    s.style.padding = "0px", s.style.width = l.querySelector("li:nth-child(1)").offsetWidth + "px", s.style.transform = "translate3d(0px, 0px, 0px)", s.style.transition = ".5s ease", l.onmouseover = function (e) {
      let t = getEventTarget(e), i = t.closest("li");
      if (i) {
...
setTimeout(function () {
  ...
  total.forEach(function (a, e) {
    ...
    var n = document.createElement("div"), i = a.querySelector(".nav-link.active").cloneNode();
    ...
    if (!n.classList.contains("flex-column")) {
      ...
      let e = n.querySelector(".nav-link.active").parentElement, t = Array.from(e.closest("ul").children);
      t.indexOf(e);
      let a = 0;
...
function darkMode(e) {
  const t = document.getElementsByTagName("body")[0], a = document.querySelectorAll("div:not(.sidenav) > hr"),
    n = document.querySelector(".sidenav"), i = document.querySelectorAll(".sidenav.bg-white"),
    ...
    g = document.querySelectorAll(".text-secondary"), m = document.querySelectorAll(".bg-gray-100"),
    ...
    b = document.querySelectorAll(".card.border"), y = document.querySelectorAll(".card.border.border-dark"),
    p = document.querySelectorAll("g"), w = document.querySelector(".navbar-brand-img"), x = w.src,
    ...
    S = document.querySelectorAll(".card .nav .nav-link i"), k = document.querySelectorAll(".card .nav .nav-link span");
...
var argon = {
  initFullCalendar: function () {
    ...
    if ("basic" == e) Swal.fire("Any fool can use a computer"); else if ("title-and-text" == e) {
      const t = Swal.mixin({
        customClass: {
